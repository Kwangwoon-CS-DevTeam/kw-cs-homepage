            ...
            <div className="relative mb-32 z-10 block overflow-visible">
                ...
                <div
                    ...
                    <div className="text-center lg:text-left flex flex-col justify-center h-full">
                        ...
                        <div className="mt-6">
                            <a
                                href="/specializations/ics" // 세부 전공의 상세 페이지 링크
                                className="inline-block backdrop-blur bg-opacity-10 bg-blue-950 text-white px-6 py-2 rounded-lg transition-all duration-300 transform group border-[1px] border-neutral-300 hover:border-1.5 hover:border-white" // 테두리 추가
                            >
